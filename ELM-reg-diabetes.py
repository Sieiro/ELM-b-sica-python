...
for b in range(1, 400, 1): #442 amostras
    # cross validation
    for train_index, test_index in fold.split(diabetes.data, diabetes.target):
...
# plot
pplot.style.use('bmh')
# MAE para número de neurônios variáveis usando Extreme Learning Machine no dataset Diabetes

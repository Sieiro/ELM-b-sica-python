...
# cria matriz one hot com 3 saídas
...
for b in range(1, 140, 1):#150 amostras
    # cross validation
...
# plot
pplot.style.use('bmh')
# Acurácia para número de neurônios variáveis usando Extreme Learning Machine no dataset Iris
